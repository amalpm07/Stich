...
export default function AiChatDetailScreen() {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    { id: '1', text: 'Welcome back to this conversation!', sender: 'ai', timestamp: Date.now() - 100000 },
    { id: '2', text: 'Thanks, can you help me with my order?', sender: 'user', timestamp: Date.now() - 90000 },
    { id: '3', text: 'Of course! What do you need help with?', sender: 'ai', timestamp: Date.now() - 80000 },
  ]);
